...
houses = [['LONDON','Terraced', '3735000'], ['CARDIFF', 'Semi-Detached', '2100000'], ['LEEDS','Terraced', '3245000'],['LONDON','Semi-Detatched', '1240000']]
sales = []
...
def house_sale():
    ...
    sub_total = int(houses[select-1][2])
    print(sub_total)
    total_fees = 0
    ...
    print('Customer Receipt\n\n  FORENAME:{}  SURNAME: {}  PROPERTY COST:  {}  WITH STAMP DUTY:   {:.2f}'.format(*sales[-1]))
